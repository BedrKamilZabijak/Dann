...
<template>
  <li>
    ...
    <div class="todo-actions">
      <Icon icon="ph:check-circle" v-if="todo.isEdited" class="icon" color="#41b000" width="22" @click="$emit('toggle-edit',index)" />
      <Icon icon="ph:pencil-fill" v-else class="icon" color="#41b000" width="22" @click="$emit('toggle-edit',index)"/>
